...
export const productsDataValidator = getValidator(
  productsDataSchema,
  dataValidator,
)
...
export const productsPatchValidator = getValidator(
  productsPatchSchema,
  dataValidator,
)
...
export const productsQueryValidator = getValidator(
  productsQuerySchema,
  queryValidator,
)
